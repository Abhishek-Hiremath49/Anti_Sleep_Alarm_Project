...
class DrowsinessDetector:
    def __init__(self):
        ...
        self.predictor = dlib.shape_predictor("C:/Users/saksh/Sakshi/VS Code/Anti/shape_predictor_68_face_landmarks (1).dat/shape_predictor_68_face_landmarks (1).dat")
        ...
        self.EYE_AR_THRESH = 0.40  # Eye aspect ratio threshold
        self.EYE_AR_CONSEC_FRAMES = 80  # Number of consecutive frames for drowsiness
